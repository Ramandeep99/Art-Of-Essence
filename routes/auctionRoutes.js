...
// let Items = require('../models/paintingModel');
// let Bids = require('../models/bid');
...
// router.get('/auction' ,authenticate,  async (req,res) => {
        
//         // console.log(message)
//         try {
//             if(message.type !== 'noItem' && message.content.currentItem[0] !== undefined){
//                 let loggedInUser = req.verifiedUser;
//                 let previous_bids = [];
...
//                 console.log(message)
//                 res.render('auction', {message,currentItem, previousBids, owner, currentPrice, previous_bids, startBidDate, loggedInUser});
//             }
//             else{
//                 let noItem = true;
